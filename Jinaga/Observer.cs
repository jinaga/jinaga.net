...
namespace Jinaga
{
    ...
    public class ObserverOld<TProjection> : IObserver
    {
        ...
        internal ObserverOld(SpecificationOld specification, Product initialAnchor, FactManager factManager, IObservation observation)
        {
            this.specification = specification;
            this.initialAnchor = initialAnchor;
            this.factManager = factManager;
